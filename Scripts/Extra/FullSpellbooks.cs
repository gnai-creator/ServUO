...
namespace Server.Items
{
	public class FullNecroSpellbook : Spellbook
	{
		...
		public override int BookCount{ get{ return ((Core.SE) ? 17 : 17); } }
...
//--Full Mystic Spell Book ((This part done by Nylo))----------------------------------------
namespace Server.Items
{
    public class FullMysticBook : Spellbook
    {
        ...
        [Constructable]
        public FullMysticBook() : this((ulong)0)
        {
            this.Content = (ulong)0xFFFF;
        }
        [Constructable]
        public FullMysticBook(ulong content) : base(content, 0x2D9D)
        {
            Layer = Layer.OneHanded;
        }

        public FullMysticBook(Serial serial)
            : base(serial)
        {
        }
