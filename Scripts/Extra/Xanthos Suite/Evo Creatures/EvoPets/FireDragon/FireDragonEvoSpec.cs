...
{
	public sealed class FireDragonSpec : BaseEvoSpec
	{
		...
		FireDragonSpec()
		{
			...
			m_RandomHues = new int[] { 2472, 2445, 2446, 2447, 2117, 1461, 338  };
			...
			m_Stages = new BaseEvoStage[] { new FireDragonStageOne(), new FireDragonStageTwo(),
											  new FireDragonStageThree(), new FireDragonStageFour(),
											  new FireDragonStageFive(), new FireDragonStageSix(),
											  new FireDragonStageSeven() };
		}
		...
		public static FireDragonSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly FireDragonSpec instance = new FireDragonSpec();}
	}	
	...
	public class FireDragonStageOne : BaseEvoStage
	{
		public FireDragonStageOne()
		{
	...
	public class FireDragonStageTwo : BaseEvoStage
	{
		public FireDragonStageTwo()
		{
			EvolutionMessage = "has evolved";
			...
			DamagesTypes = new ResistanceType[5] { ResistanceType.Fire, ResistanceType.Physical, ResistanceType.Cold,
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 20, 25, 15, 20, 20 };
			MaxResistances = new int[5] { 20, 25, 15, 20, 20 };
	...
	public class FireDragonStageThree : BaseEvoStage
	{
		public FireDragonStageThree()
		{
			EvolutionMessage = "has evolved";
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 40, 45, 35, 40, 40 };
			MaxResistances = new int[5] { 40, 45, 35, 40, 40 };
	...
	public class FireDragonStageFour : BaseEvoStage
	{
		public FireDragonStageFour()
		{
			EvolutionMessage = "has evolved";
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 60, 65, 55, 60, 60 };
			MaxResistances = new int[5] { 60, 65, 55, 60, 60 };	
	...
	public class FireDragonStageFive : BaseEvoStage
	{
		public FireDragonStageFive()
		{
			EvolutionMessage = "has evolved";
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 80, 85, 75, 80, 80 };
			MaxResistances = new int[5] { 80, 85, 75, 80, 80 };	
	...
	public class FireDragonStageSix : BaseEvoStage
	{
		public FireDragonStageSix()
		{
			EvolutionMessage = "has evolved";
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 98, 98, 90, 98, 98 };
			MaxResistances = new int[5] { 98, 98, 90, 98, 98 };	
	...
	public class FireDragonStageSeven : BaseEvoStage
	{
		public FireDragonStageSeven()
		{
			Title = "The Ancient Fire Dragon";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Fire Dragon";
