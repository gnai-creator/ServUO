...
{
	[CorpseName( "a guardian poison dragon corpse" )]
	public class GuardianPoisonDragon : PoisonDragon
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianPoisonDragon() : base( "A Guardian poison dragon" )
		{
		

		Name = "Guardian Evo Poison Dragon";
            Body = 0X2E;
		...
		switch ( Utility.Random( 20 ))
            {                                   
            	case 0: AddItem( new PoisonDragonEgg() ); break;
            }	
       ...
       public GuardianPoisonDragon( Serial serial ) : base( serial )
          {
		}
