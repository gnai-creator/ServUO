...
{
	public sealed class PoisonDragonSpec : BaseEvoSpec
	{
		...
		PoisonDragonSpec()
		{
			...
			m_RandomHues = new int[] { 1372, 1267, 1914, 2469, 2470, 2471 };
			...
			m_Stages = new BaseEvoStage[] { new PoisonDragonStageOne(), new PoisonDragonStageTwo(),
											  new PoisonDragonStageThree(), new PoisonDragonStageFour(),
											  new PoisonDragonStageFive(), new PoisonDragonStageSix(),
											  new PoisonDragonStageSeven() };
		}
		...
		public static PoisonDragonSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly PoisonDragonSpec instance = new PoisonDragonSpec();}
	}	
	...
	public class PoisonDragonStageOne : BaseEvoStage
	{
		public PoisonDragonStageOne()
		{
	...
	public class PoisonDragonStageTwo : BaseEvoStage
	{
		public PoisonDragonStageTwo()
		{
			EvolutionMessage = "has evolved";
			...
			DamagesTypes = new ResistanceType[5] { ResistanceType.Poison, ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
			...
			MaxResistances = new int[5] { 20, 20, 20, 25, 15 };
	...
	public class PoisonDragonStageThree : BaseEvoStage
	{
		public PoisonDragonStageThree()
		{
			EvolutionMessage = "has evolved";
			...
			MaxResistances = new int[5] { 40, 40, 40, 45, 35 };
	...
	public class PoisonDragonStageFour : BaseEvoStage
	{
		public PoisonDragonStageFour()
		{
			EvolutionMessage = "has evolved";
			...
			MaxResistances = new int[5] { 60, 60, 60, 65, 55 };	
	...
	public class PoisonDragonStageFive : BaseEvoStage
	{
		public PoisonDragonStageFive()
		{
			EvolutionMessage = "has evolved";
			...
			MaxResistances = new int[5] { 80, 80, 80, 85, 75 };	
	...
	public class PoisonDragonStageSix : BaseEvoStage
	{
		public PoisonDragonStageSix()
		{
			EvolutionMessage = "has evolved";
			...
			MaxResistances = new int[5] { 98, 98, 98, 98, 90 };	
	...
	public class PoisonDragonStageSeven : BaseEvoStage
	{
		public PoisonDragonStageSeven()
		{
			Title = "The Ancient Poison Dragon";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Poison Dragon";
