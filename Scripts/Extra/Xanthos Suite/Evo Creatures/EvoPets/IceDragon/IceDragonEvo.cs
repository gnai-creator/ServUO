...
namespace Xanthos.Evo
{
	...
	public class IceDragon : BaseEvo, IEvoCreature
	{
		public override BaseEvoSpec GetEvoSpec()
		{
			return IceDragonSpec.Instance;
		}

		public override BaseEvoEgg GetEvoEgg()
		{
			return new IceDragonEgg();
		}

		public override bool AddPointsOnDamage { get { return true; } }
		public override bool AddPointsOnMelee { get { return true; } }
		public override Type GetEvoDustType() { return typeof( IceDragonDust ); }

		//public override bool HasBreath{ get{ return true; } }
	

		public IceDragon( string name ) : base( name, AIType.AI_Mage, 0.01 )
		{
		}
