...
{
	public sealed class IceDragonSpec : BaseEvoSpec
	{
		...
		IceDragonSpec()
		{
			...
			m_RandomHues = new int[] { 1152, 1151, 1173, 1195, 1266, 1927, 2440, 2465, 2499 };
			...
			m_Stages = new BaseEvoStage[] { new IceDragonStageOne(), new IceDragonStageTwo(),
											  new IceDragonStageThree(), new IceDragonStageFour(),
											  new IceDragonStageFive(), new IceDragonStageSix(),
											  new IceDragonStageSeven() };
		}
		...
		public static IceDragonSpec Instance { get { return Nested.instance; } }
		class Nested { static Nested() { } internal static readonly IceDragonSpec instance = new IceDragonSpec();}
	}	
	...
	public class IceDragonStageOne : BaseEvoStage
	{
		public IceDragonStageOne()
		{
	...
	public class IceDragonStageTwo : BaseEvoStage
	{
		public IceDragonStageTwo()
		{
			EvolutionMessage = "has evolved";
			...
			DamagesTypes = new ResistanceType[5] { ResistanceType.Cold, ResistanceType.Physical, ResistanceType.Fire,
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 20, 10, 30, 20, 20 };
			MaxResistances = new int[5] { 20, 10, 30, 20, 20 };
	...
	public class IceDragonStageThree : BaseEvoStage
	{
		public IceDragonStageThree()
		{
			EvolutionMessage = "has evolved";
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 40, 30, 50, 40, 40 };
			MaxResistances = new int[5] { 40, 30, 50, 40, 40 };
	...
	public class IceDragonStageFour : BaseEvoStage
	{
		public IceDragonStageFour()
		{
			EvolutionMessage = "has evolved";
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 60, 50, 70, 60, 60 };
			MaxResistances = new int[5] { 60, 50, 70, 60, 60 };	
	...
	public class IceDragonStageFive : BaseEvoStage
	{
		public IceDragonStageFive()
		{
			EvolutionMessage = "has evolved";
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 80, 70, 80, 80, 80 };
			MaxResistances = new int[5] { 80, 70, 80, 80, 80 };	
	...
	public class IceDragonStageSix : BaseEvoStage
	{
		public IceDragonStageSix()
		{
			EvolutionMessage = "has evolved";
			...
			ResistanceTypes = new ResistanceType[5] { ResistanceType.Physical, ResistanceType.Fire, ResistanceType.Cold,
														ResistanceType.Poison, ResistanceType.Energy };
			MinResistances = new int[5] { 98, 80, 98, 98, 98 };
			MaxResistances = new int[5] { 98, 80, 98, 98, 98 };	
	...
	public class IceDragonStageSeven : BaseEvoStage
	{
		public IceDragonStageSeven()
		{
			Title = "The Ancient Ice Dragon";
			EvolutionMessage = "has evolved to its highest form and is now an Ancient Ice Dragon";
