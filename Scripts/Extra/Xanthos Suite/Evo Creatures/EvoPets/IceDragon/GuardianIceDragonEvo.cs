...
{
	[CorpseName( "a guardian ice dragon corpse" )]
	public class GuardianIceDragon : IceDragon
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianIceDragon() : base( "A Guardian Ice Dragon" )
		{
		

		Name = "Guardian Evo Ice Dragon";
            Body = 0X2E;
		...
		switch ( Utility.Random( 20 ))
            {                                   
            	case 0: AddItem( new IceDragonEgg() ); break;
            }	
       ...
       public GuardianIceDragon( Serial serial ) : base( serial )
          {
		}
