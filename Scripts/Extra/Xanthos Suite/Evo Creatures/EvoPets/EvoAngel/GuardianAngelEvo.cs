...
{
	[CorpseName( "a guardian angel corpse" )]
	public class GuardianAngel : Angel
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianAngel() : base( "A Guardian Angel" )
		{
		

		Name = "Guardian Evo Angel";
            Body = 175;
		...
		switch ( Utility.Random( 20 ))
            {                                   
            	case 0: AddItem( new AngelEgg() ); break;
            }	
