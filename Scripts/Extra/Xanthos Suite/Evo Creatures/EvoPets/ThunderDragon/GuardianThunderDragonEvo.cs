...
{
	[CorpseName( "a guardian thunder dragon corpse" )]
	public class GuardianThunderDragon : ThunderDragon
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianThunderDragon() : base( "A Guardian thunder dragon" )
		{
		

		Name = "Guardian Evo Thunder Dragon";
            Body = 0X2E;
		...
		switch ( Utility.Random( 20 ))
            {                                   
            	case 0: AddItem( new ThunderDragonEgg() ); break;
            }	
       ...
       public GuardianThunderDragon( Serial serial ) : base( serial )
          {
		}
