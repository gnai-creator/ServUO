...
{
	[CorpseName( "a guardian treefellow corpse" )]
	public class TreeGuardian : Tree
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public TreeGuardian() : base( "A Guardian Treefellow" )
		{
		

		Name = "Guardian Evo Treefellow";
            Body = 47;
		...
		switch ( Utility.Random( 20 ))
            {                                   
            	case 0: AddItem( new TreeSeed() ); break;
            }	
       ...
       public TreeGuardian( Serial serial ) : base( serial )
          {
		}
