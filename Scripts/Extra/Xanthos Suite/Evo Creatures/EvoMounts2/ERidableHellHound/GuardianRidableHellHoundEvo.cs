...
{
    [CorpseName("guardian ridable hell hound corpse")]
	public class GuardianRidableHellHound : EvoRidableHellHound
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianRidableHellHound() : base( "A Guardian Ridable Hell Hound" )
		{
		

		Name = "Guardian Evo Ridable Hell Hound";
            Body = 0x42d;
            Hue = 0;
		...
		switch ( Utility.Random( 20 ))
            {
                case 0: AddItem(new RidableHellHoundEvoEgg()); break;
            }	
          ...
          public GuardianRidableHellHound(Serial serial)
              : base(serial)
          {
		}
