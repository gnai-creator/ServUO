...
{
    [CorpseName("guardian swamp dragon corpse")]
	public class GuardianSwampDragon : EvoSwampDragon
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianSwampDragon() : base( "A Guardian Swamp Dragon" )
		{
		

		Name = "Guardian Evo Swamp Dragon";
            Body = 794;
		...
		switch ( Utility.Random( 20 ))
            {
                case 0: AddItem(new SwampDragonEvoEgg()); break;
            }	
          ...
          public GuardianSwampDragon(Serial serial)
              : base(serial)
          {
		}
