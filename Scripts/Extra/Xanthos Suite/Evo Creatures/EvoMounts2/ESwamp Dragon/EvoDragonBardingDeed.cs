...
{
    public class EvoDragonBardingDeed : Item, ICraftable
    {
        ...
        [Constructable]
        public EvoDragonBardingDeed()
            : base(0x14F0)
        {
            Name = "Evo Swamp Dragon Barding Deed";
			Weight = 1.0;
        }
        ...
        public virtual void OnTarget(Mobile from, object obj)
        {
            ...
            EvoSwampDragon pet = obj as EvoSwampDragon;
        ...
        public EvoDragonBardingDeed(Serial serial)
            : base(serial)
        {
        }
